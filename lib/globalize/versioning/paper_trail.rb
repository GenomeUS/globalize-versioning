...
ActiveRecord::Base.class_eval do
  class << self
    ...
    alias_method :globalize, :has_paper_trail
    alias_method :has_paper_trail, :globalize
  end
end
...
PaperTrail::Version.class_eval do
  ...
  alias_method :locales, :sibling_versions
  alias_method :sibling_versions, :locales
end
